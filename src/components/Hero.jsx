...
const Hero = () => {
  return (
    ...
    <section className="relative bg-gradient-to-br from-white via-green-50 to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 pt-10 pb-10 overflow-hidden">
      ...
      <div className="relative container mx-auto px-6 flex flex-col md:flex-row items-center">
        ...
        <div className="flex-1 space-y-8 text-center md:text-left">
          ...
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-lg mx-auto md:mx-0 animate-fade-in delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start animate-fade-in delay-400">
            ...
            <Link href="/study-plan">
              <button className="px-6 py-3 rounded-xl border border-green-400 text-green-600 dark:text-green-300 font-semibold shadow hover:shadow-lg transition-all duration-300 backdrop-blur-md hover:scale-105">
                Learn More
              </button>
            </Link>
          </div>
